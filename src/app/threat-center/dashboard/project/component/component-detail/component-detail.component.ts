...
export class ComponentDetailComponent implements OnInit {
  ...
  private calculateLogic(license) {
    ...
    console.log("ARRAY2:",
      originalArray.filter(function(s) {
          return s.node.licenseDiscovery === 'DECLARED' || s.node.licenseOrigin === 'REPOSITORY_META';
      }));
    //console.log("ARRAY1:", originalArray.filter(s => s.node.licenseDiscovery.includes('DECLARED') || s.node.licenseOrigin.includes('REPOSITORY_META')) );
    //console.log("ARRAY2:", originalArray.filter(s => (s.node.licenseDiscovery === 'DECLARED' || s.node.licenseOrigin === 'REPOSITORY_META')));
    ...
    this.licensesList = originalArray.filter(function(s) {
        return s.node.licenseDiscovery === 'DECLARED' || s.node.licenseOrigin === 'REPOSITORY_META';
    });
