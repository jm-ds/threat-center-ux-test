...
import {VulnCodeByNameWithCVEsIsVulnerable} from "@app/threat-center/shared/models/types";
...
export class VulnerableCodeMappingService {
    ...
    vulnerabilitiesWithCvssV3(componentId: string): Observable<VulnCodeByNameWithCVEsIsVulnerable[]> {
        ...
        return this.coreHttpService.httpGetWithParamsRequest<VulnCodeByNameWithCVEsIsVulnerable[]>(url, new HttpHeaders(), params).pipe();
    }
}
